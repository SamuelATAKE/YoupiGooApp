            ...
            <div className="row justify-content-center">
              <div className="col-lg-6">
                <div className="section-title text-center">
                  ...
                  <p>
                    Composée de personnes dynamiques, à la recherche de
                    l'innovation et surtout de la satisfaction du potentiel
                    client
                  </p>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-xl-3 col-lg-6 col-md-5 offset-xl-2">
                  <div className="section-title mb-md-0">
                    ...
                    <p>
                      Abonnez-vous pour recevoir toutes les nouvelles offres
                    </p>
                  </div>
                </div>
