			    ...
			    <div className="row justify-content-center">
			      <div className="col-lg-6">
			        <div className="section-title text-center">
			          <h2 className="title">Notre histoire</h2>
			        ...
			        <div className="single-destination-grid style-two">
			          ...
			          <div className="details">
			            <ul className="d-list-meta">
			              ...
			              <li><img src={publicUrl+"assets/img/icons/13.png"} alt="img" /> 550+ Trajets effectués</li>
			              <li><img src={publicUrl+"assets/img/icons/14.png"} alt="img" /> 2 Awards gagnés</li>
			            </ul>
