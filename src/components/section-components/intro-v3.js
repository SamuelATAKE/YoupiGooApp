    ...
    return  <div className="intro-area pd-top-108">
			  <div className="container">
			    <div className="section-title text-lg-center text-left">
			      <h2 className="title"><span>Nous sommes</span> un point de voyage</h2>
			    </div>
			    <div className="row">
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          ...
			          <h4 className="intro-title">Transport privé</h4>
			      ...
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          ...
			          <h4 className="intro-title">Diverses Destinations</h4>
			      ...
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          ...
			          <h4 className="intro-title">Grandes Hôtels</h4>
			      ...
			      <div className="col-lg-3 col-md-6">
			        <div className="single-intro style-two">
			          ...
			          <h4 className="intro-title">Réservation rapide</h4>
