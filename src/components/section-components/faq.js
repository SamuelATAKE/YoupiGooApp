            ...
            <div className="col-xl-3 col-lg-4">
              <aside className="sidebar-area">
                ...
                <div className="widget widget_categories mb-0">
                  ...
                  <ul>
                    <li>
                      <Link href="/#">Software</Link> 33
                    </li>
                    <li>
                      <Link href="/#">App Landing</Link> 81
                    </li>
                    <li>
                      <Link href="/#">Saas Landing</Link> 12
                    </li>
                    <li>
                      <Link href="/#">Design Studio</Link> 17
                    </li>
                    <li>
                      <Link href="/#">Product Showcase</Link> 62
                    </li>
                  </ul>
                </div>
              </aside>
